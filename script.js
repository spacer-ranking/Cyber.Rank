...
// Показать команду (улучшенный интерфейс)
...
async function addPlayerToTeam() {
    ...
    // Проверка на добавление самого себя (лидера)
    if (member_name === currentUser?.username) {
        showError('addPlayerError', 'Вы уже являетесь лидером этой команды');
        return;
    }
