                ...
                html += `
                    <div class="team-card" onclick="window.showTeam(${team.id})">
                        <div class="team-header">
                            <div class="team-avatar" style="background: linear-gradient(135deg, #ff4655, #00ffff);"></div>
                            <div class="team-info">
                    ...
                    <div class="match-card" id="match-${match.id}">
                        <div class="match-teams">
                            <div class="match-team ${match.winner_id === match.team1_id ? 'winner' : ''}">
                                <div class="match-team-avatar" style="background: linear-gradient(135deg, #ff4655, #00ffff);"></div>
        ...
        let html = `
            <div class="team-page">
                <div class="team-page-header">
                    <div class="team-page-avatar" style="background: linear-gradient(135deg, #ff4655, #00ffff);"></div>
                ...
                html += `
                    <div class="member-item ${isLeader ? 'leader-item' : ''}">
                        <div class="member-info">
                            ...
                            ${isLeader ? '<span class="leader-badge-small">👑</span>' : ''}
...
function uploadTeamAvatar(teamId) {
    ...
    input.onchange = async (e) => {
        ...
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                document.querySelector('.team-page-avatar').style.backgroundImage = `url(${data.avatar})`;
