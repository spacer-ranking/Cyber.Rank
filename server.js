...
// ========== ИСПРАВЛЕНО: создание команды БЕЗ автоматического добавления лидера ==========
    ...
    db.get("SELECT * FROM teams WHERE name = ?", [name], (err, team) => {
        ...
        db.run("INSERT INTO teams (name, leader_id, rating) VALUES (?, ?, 0)",
            ...
            function(err) {
                ...
                // ❌ Убрано: больше НЕ добавляем лидера в team_members автоматически
                // Лидер будет добавлен только через кнопку "Добавить игрока"
